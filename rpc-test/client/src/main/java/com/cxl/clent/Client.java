...
public class Client {
    ...
    private static void testSYNC() {
        Deom deom= (Deom) new RpcReferenceBean(NetEnum.NETTY, Serializer.SerializerEnum.JACKSON.getSerializer(), CallType.SYNC, LoadBalance.ROUND,Deom.class,null,500,"127.0.0.1:8000",null,null,null).getObject();
